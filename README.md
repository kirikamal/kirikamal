...
- **MediParse** - Automated prescription and patient data extraction system using FastAPI, OpenCV, and Tesseract OCR, with structured output powered by regex-based parsing.
